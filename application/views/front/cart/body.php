...
<br>
			<p>SYARAT & KETENTUAN SEWA (WAJIB BACA)
				<hr>
				<li>Tanda jadi bersifat non refundable jika terjadi pembatalan sewa / perubahan tanggal sewa Jika Tanda Jadi sudah dibayarkan dan ternyata ada perubahan tanggal sewa, maka <b>GOAL RUSH ARENA</b> tidak menjamin bahwa unit masih tersedia pada tanggal baru yang diminta oleh Penyewa.</li>

				<li>Sesuai dengan namanya, Tanda Jadi atau Booking Fee ataupun Pembayaran (DP ataupun Full Payment) merupakan bentuk komitmen Penyewa untuk melakukan konfirmasi sewa pada tanggal yang disepakati (tanggal yang dibooking).</li> 
				<li>Dalam hal perubahan tanggal yang diminta unit sudah tidak tersedia (fully booked), <b>GOAL RUSH ARENA</b> berhak untuk tidak memenuhi order tersebut penalti atas biaya sewa yang telah dibayarkan </li>
				<li>Demi kenyamanan & kelancaran jadwal semua pihak, mohon agar datang lebih awal 30 menit dari jadwal yang fix, petugas kami hanya akan menunggu di lokasi maksimal 1 jam dari jam yang sudah ditentukan. Lebih dari itu maka petugas kami akan membatalkan otomatis lapangan yang anda sewa.</li>
 				<br>
				Kebijakan ini kami buat semata-mata untuk menjaga kenyamanan & kelancaran jadwal seluruh Penyewa kami.</p>
				<p> ~~Terima Kasih~~</p>
</div>
